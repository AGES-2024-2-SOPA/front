    ...
    return (
        <div className="flex h-screen justify-center items-center bg-amber-50">
            <div className="flex w-[80%] h-[80%] shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="w-1/2 bg-white flex flex-col justify-start items-center p-10"> {/*Primeira metade da tela*/}
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-sm flex flex-col space-y-6">
                        ...
                        <Input
                            ...
                            {...register("email")}
                        />
                        {errors.email && <p className="text-red-500 text-xs mt-1">{errors.email.message}</p>} {/* Mensagem de erro */}
                        ...
                        <Input
                            ...
                            {...register("password")}
                        />
                        {errors.password && <p className="text-red-500 text-xs mt-1">{errors.password.message}</p>} {/* Mensagem de erro */}
                ...
                <div className="w-1/2 bg-orange-500 flex flex-col justify-center items-center"> {/*Segunda metade da tela*/}
